headStyle(fontsize)
  padding-left: unit(fontsize + 1.1, "rem") !important;

  code
    font-size: unit(fontsize, "rem")

  &:before
    top: calc(50%-unit(fontsize*0.75, "rem")-0.15) !important;
    font-size: unit(fontsize*1.5, "rem") !important;

  &:hover
    padding-left: unit(fontsize + 1.3, "rem") !important;
