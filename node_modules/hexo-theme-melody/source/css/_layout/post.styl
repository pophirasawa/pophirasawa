headStyle(fontsize)
  padding-left: unit(fontsize + 1.1, "rem")

  code
    font-size: unit(fontsize*1.8, "rem")

  &:before
    top: unit(fontsize/1.5, "rem")
    font-size: unit(fontsize*1.5, "rem")

  &:hover
    padding-left: unit(fontsize + 1.3, "rem")
